...
![Tests](https://img.shields.io/badge/tests-2540-brightgreen)
...
# Run on-chain tests (529 LiteSVM tests — no validator needed)
...
| Instruction constraints (generic enforcement)                           | 62       |
...
| Post-execution assertions E2E (CrossFieldLte golden/evil + fail-closed) | 9        |
